  ...
  return (
    <header className="bg-brown px-6 py-5 text-center relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(circle, rgba(232,201,122,0.15) 1px, transparent 1px)',
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-center gap-4 mb-1">
          ...
          <div className="text-left">
            <span className="block font-mono text-[11px] tracking-[6px] uppercase text-gold">Follow</span>
            <span className="block font-serif italic font-black text-[15px] text-gold leading-tight">the</span>
            <span className="block font-display text-[42px] tracking-[4px] text-gold leading-none"
              style={{ textShadow: '2px 2px 0 rgba(0,0,0,.25), 4px 4px 0 rgba(0,0,0,.15)' }}>
              <span className="text-white">DO</span>UGH
            </span>
          </div>
        </div>
        <div className="inline-flex items-center gap-2 bg-ftdred px-4 py-1 text-[9px] tracking-[3px] uppercase text-white mt-2"
          style={{ transform: 'rotate(-1deg)' }}>
          🗳 Know who&apos;s buying your ballot
        </div>
        <p className="text-[9px] tracking-[3px] uppercase text-gold/25 mt-2">
