...
const SPOTLIGHT_BILLS: Array<{ bill: any; why: string; conflict: string }> = [
  ...
  },
  {
    bill: {
      ...
      sponsorParty: 'R',
      sponsorChamber: 'H',
      latestAction: 'Passed House — blocked from Senate floor by Democrats (50–46, short of 60-vote threshold)',
      actionDate: '2026-08-04',
    },
    why: 'The $1.15T defense policy bill passed the House on July 22, 2026, but Senate Democrats blocked it from advancing to the floor on Aug 4 over concerns about Iran war authority and the defense topline — the vote fell 50–46, short of the 60 needed. Leaders are now negotiating an informal House–Senate compromise, with a final reconciled vote expected in a post-election session before the December adjournment. Section 219 directs the Pentagon to integrate U.S. and Israeli military research and development; Section 622 expands intelligence-sharing with Israel. An amendment from Reps. Thomas Massie (R-KY) and Ro Khanna (D-CA) to strip Section 219 was blocked from a floor vote by the Rules Committee.',
  ...
  },
  {
    bill: {
      ...
      sponsorName: 'French Hill',
      sponsorState: 'AR',
      sponsorParty: 'R',
      sponsorChamber: 'H',
      latestAction: 'Passed House 294–134 — Senate vote scheduled for Sept. 15, 2026',
      actionDate: '2026-08-08',
    },
    why: 'Would write the first comprehensive federal rulebook for crypto markets, making the CFTC the primary regulator of crypto exchanges and brokers. It passed the House 294–134 in 2025, and the Senate opened procedural voting on Aug 8, 2026 before recessing — a full floor vote is scheduled for Sept. 15, right after Congress returns. It needs at least 10 Senate Democrats to clear the 60-vote threshold, and support is uncertain over unresolved ethics language.',
    conflict: 'President Trump personally profits from crypto: his July 2026 financial disclosure logged roughly $1.4B in crypto income for 2025, mostly from his family\'s World Liberty Financial venture and his memecoin. The CLARITY Act\'s ethics section nominally bars the President, VP and senior officials from "issuing" or "sponsoring" new crypto products while in office — but it explicitly grandfathers in preexisting ventures like World Liberty Financial to keep minting and selling under Trump\'s name, and the whole ethics provision sunsets in January 2029. Separately, Trump-appointed regulators approved World Liberty Financial\'s bid to become a chartered bank in August 2026, a move Sen. Elizabeth Warren and watchdogs called "a brazen act of self-dealing." Sponsor Rep. French Hill chairs the House Financial Services Committee, which oversees the crypto industry the bill would newly regulate.',
  },
];
